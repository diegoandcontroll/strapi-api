...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/diegoandcontroll',
  },
  
  {
    name: 'Twitter',
    link: 'https://twitter.com/yxydiego',
  },
  {
    name: 'Linkedin',
    link: 'https://www.linkedin.com/in/diego-lucas-293682181/',
  },
];
      ...
      <Container className="container-fluid">
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              <Wave />
              <h2 id="mainHeader">Bem vindo ao wongames!</h2>
